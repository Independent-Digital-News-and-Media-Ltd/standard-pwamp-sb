...
`,Sidebar=__webpack_require__(331),brandpost=__webpack_require__(163),MarkupEmbed=__webpack_require__(112),NewsletterComponent=__webpack_require__(322),classnames=__webpack_require__(29),classnames_default=__webpack_require__.n(classnames);const Wrapper=styled_components_browser_esm.default.div`
  display: flex;
  align-items: center;
...
`,SectionContent=({insert:insert,components:components,publication:publication,theme:theme,configuration:configuration,section:section,secondaryPublication:secondaryPublication})=>{let adIndex=1;const path=section.section.path;return Object(jsx_runtime.jsxs)(Content_Wrapper,{className:"section-content",componentStyle:theme,children:[secondaryPublication&&path===brandpost.b&&Object(jsx_runtime.jsx)(Section_BrandPost,{data:secondaryPublication}),"author"===section.type&&Object(jsx_runtime.jsx)(Author_AuthorRow,{author:section.section}),"author"!==section.type&&insert,null==components?void 0:components.filter(skipComponentHasNoArticle).map((comp,i)=>{const Component=componentMap[comp.type],key=`${comp.type}${i}`;let thirdpartyShown=!1;const hasTitle=!!comp.labelText;switch(comp.type){case"Title":case"LiveNowX3":case"Markup":case"HeroArticle":case"HeroPlus2Articles":case"HeroPlus4Articles":case"HeroX2Plus2Articles":case"ArticleX2":case"ArticleX3":case"ArticleX4":case"CarouselX6":case"CommentHighlight":case"Voucher":return Object(jsx_runtime.jsx)(Component,{componentStyle:theme,data:comp,configuration:configuration,path:path,hasTitle:hasTitle},key);case"HeroPlusDMPU":case"HeroX2Plus2ArticlesPlusDMPU":case"TrendingEditorsPickPlusDMPU":case"ArticleX2PlusMPU":{var _comp$ad,_comp$ad$adSource,_comp$ad2;let mpuId="ayl";return"partner"!==(null===(_comp$ad=comp.ad)||void 0===_comp$ad||null===(_comp$ad$adSource=_comp$ad.adSource)||void 0===_comp$ad$adSource?void 0:_comp$ad$adSource.toLowerCase())||thirdpartyShown?"none"!==(null===(_comp$ad2=comp.ad)||void 0===_comp$ad2?void 0:_comp$ad2.adSource)&&(mpuId="mpu"+adIndex,adIndex++):thirdpartyShown=!0,Object(jsx_runtime.jsx)(Component,{publication:publication,mpuId:mpuId,data:comp,componentStyle:theme,configuration:configuration,hasTitle:hasTitle},key)}case"BreakingNewsTicker":return"";case"NewsLetterSignup":return Object(jsx_runtime.jsx)(NewsletterComponent.a,{newsletterTarget:comp.newsletterTarget},comp.type+i);default:return Object(jsx_runtime.jsxs)("p",{style:{color:"red"},children:["Undefined component: ",comp.type]},"undefined"+i)}})]})};SectionContent.propTypes={components:prop_types_default.a.array,configuration:prop_types_default.a.object.isRequired,secondaryPublication:prop_types_default.a.object,insert:prop_types_default.a.node,publication:prop_types_default.a.any.isRequired,theme:prop_types_default.a.string.isRequired,section:prop_types_default.a.object.isRequired,hasBreakingNewsWithoutTitle:prop_types_default.a.bool.isRequired},SectionContent.__docgenInfo={description:"",methods:[],displayName:"SectionContent",props:{components:{type:{name:"array"},required:!1,description:""},configuration:{type:{name:"object"},required:!0,description:""},secondaryPublication:{type:{name:"object"},required:!1,description:""},insert:{type:{name:"node"},required:!1,description:""},publication:{type:{name:"any"},required:!0,description:""},theme:{type:{name:"string"},required:!0,description:""},section:{type:{name:"object"},required:!0,description:""},hasBreakingNewsWithoutTitle:{type:{name:"bool"},required:!0,description:""}}};var Section_Content=SectionContent;"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["app/component/pages/Section/Content.js"]={name:"SectionContent",docgenInfo:SectionContent.__docgenInfo,path:"app/component/pages/Section/Content.js"});const getSectionInsert=section=>{switch(section.type){case"author":return Object(jsx_runtime.jsx)(Author_AuthorRow,{author:section.section});default:return null}},Section=props=>{const{className:className,section:section,menu:menu,configuration:configuration,structuredData:structuredData,secondaryPublication:secondaryPublication,req:{path:path}}=props,domain=configuration.domain,adToggle=Object(ads.c)(section),currentSection=section.section,sectionTheme=path.startsWith("/insider")?"insider":"default";return Object(jsx_runtime.jsxs)(Frame.a,{domain:domain,publication:section.publication,configuration:configuration,menu:menu,className:className,children:[Object(jsx_runtime.jsxs)(Helmet.Helmet,{children:[Object(jsx_runtime.jsx)("title",{children:Object(page.a)({section:section},configuration.name)}),Object(jsx_runtime.jsx)("link",{rel:"alternate",href:configuration.baseUrl+("/"===currentSection.path?"/rss":currentSection.path+"/rss"),title:"RSS",type:"application/rss+xml"}),structuredData&&Object.entries(structuredData).map(Object(jsonLD.b)(domain)).map(Object(jsonLD.a)(domain)).filter(x=>!!x).map((json,index)=>Object(jsx_runtime.jsx)("script",{type:"application/ld+json",children:JSON.stringify(json)},index))]}),adToggle(ads.b)&&Object(jsx_runtime.jsx)(TopBanner.a,{width:"728",height:"90",cleanAmp:!1}),Object(jsx_runtime.jsxs)(ColumnWrapper,{flushGap:Array.isArray(section.components)&&"Title"!==section.components[0].type,children:[Object(jsx_runtime.jsx)(Section_Content,{components:section.components,insert:getSectionInsert(section),publication:section.publication,secondaryPublication:secondaryPublication,theme:sectionTheme,configuration:configuration,section:section}),section.sidebar&&Object(jsx_runtime.jsx)(Sidebar.a,{domain:domain,adToggle:adToggle,cleanAmp:!1,sidebar:section.sidebar})]})]})};Section.propTypes={className:prop_types_default.a.string,section:prop_types_default.a.object.isRequired,secondaryPublication:prop_types_default.a.object,menu:prop_types_default.a.object.isRequired,configuration:prop_types_default.a.object.isRequired,structuredData:prop_types_default.a.object,req:prop_types_default.a.object.isRequired};__webpack_exports__.default=Object(styled_components_browser_esm.default)(Object(RequestProvider.withRequest)(Section))`
  display: flex;
  justify-content: center;
`},1516:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var jsx_runtime=__webpack_require__(0),Helmet=__webpack_require__(43),RequestProvider=__webpack_require__(7),prop_types=__webpack_require__(1),prop_types_default=__webpack_require__.n(prop_types),styled_components_browser_esm=__webpack_require__(2);var Frame=__webpack_require__(102),Styles=__webpack_require__(3);const Section=styled_components_browser_esm.default.section`
  background-color: ${props=>props.theme.color.contrastLight};
...
`,SubscribeAccordion=({className:className,title:title,isFAQs:isFAQs,product:product})=>Object(jsx_runtime.jsx)(SubscribeAccordion_Section,{className:className,children:Object(jsx_runtime.jsxs)(SubscribeAccordion_SectionInner,{children:[Object(jsx_runtime.jsx)(SubscribeAccordion_Title,{children:title}),isFAQs&&Object(jsx_runtime.jsx)(Subscribe_SubscribeFaqs,{product:product})]})});SubscribeAccordion.propTypes={className:prop_types_default.a.string,title:prop_types_default.a.string,isFAQs:prop_types_default.a.bool,product:prop_types_default.a.string},SubscribeAccordion.__docgenInfo={description:"",methods:[],displayName:"SubscribeAccordion",props:{className:{type:{name:"string"},required:!1,description:""},title:{type:{name:"string"},required:!1,description:""},isFAQs:{type:{name:"bool"},required:!1,description:""},product:{type:{name:"string"},required:!1,description:""}}};var Subscribe_SubscribeAccordion=SubscribeAccordion;"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["app/component/library/Subscribe/SubscribeAccordion.js"]={name:"SubscribeAccordion",docgenInfo:SubscribeAccordion.__docgenInfo,path:"app/component/library/Subscribe/SubscribeAccordion.js"});const App_Wrapper=styled_components_browser_esm.default.div``,App=({className:className,req:{cookies:cookies}})=>{const location=cookies.subscriber_origin||"uk";return Object(jsx_runtime.jsxs)(Frame.a,{className:className,headerType:"simple",children:[Object(jsx_runtime.jsx)(Helmet.Helmet,{children:Object(jsx_runtime.jsx)("title",{children:"Evening Standard App"})}),Object(jsx_runtime.jsxs)(App_Wrapper,{className:"subscribe-app",children:[Object(jsx_runtime.jsx)(Subscribe_AppContent,{header:"Our brand new free app.<span>Latest News.</span> <span>Supplements & Puzzles.</span>",type:"header",location:location}),Object(jsx_runtime.jsx)(Subscribe_SubscribeAccordion,{title:"FAQs",isFAQs:!0,product:"app"})]})]})};App.propTypes={className:prop_types_default.a.string,req:prop_types_default.a.object.isRequired};__webpack_exports__.default=Object(styled_components_browser_esm.default)(Object(RequestProvider.withRequest)(App))`
  justify-content: center;
`},1517:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var jsx_runtime=__webpack_require__(0),Helmet=__webpack_require__(43),RequestProvider=__webpack_require__(7),classnames=__webpack_require__(29),classnames_default=__webpack_require__.n(classnames),prop_types=__webpack_require__(1),prop_types_default=__webpack_require__.n(prop_types),styled_components_browser_esm=__webpack_require__(2),Styles=__webpack_require__(3),ConditionalFrame=__webpack_require__(329),postCodePatterns=__webpack_require__(330),FormSelect=__webpack_require__(182),FormSubmit=__webpack_require__(127),FormTextField=__webpack_require__(64);const Wrapper=styled_components_browser_esm.default.div`
  color: ${props=>props.theme.color.contrastDarker};
  max-width: 410px;
  margin: 38px 12px 0;
...
//# sourceMappingURL=main.7a881b49b0c4d81cdcc9.bundle.js.map