...
`,withScript=__webpack_require__(214);const FullMenuWrapper=styled_components_browser_esm.default.div`
  font-family: ${props=>props.theme.fontFamily.secondaryFont};
  display: none;
  padding: 0 20px 20px;
  background: ${props=>props.theme.color.contrastLight};
...
`,Sidebar=__webpack_require__(337),brandpost=__webpack_require__(165),MarkupEmbed=__webpack_require__(115),NewsletterComponent=__webpack_require__(328),classnames=__webpack_require__(21),classnames_default=__webpack_require__.n(classnames);const Wrapper=styled_components_browser_esm.default.div`
  display: flex;
  align-items: center;
...
`;const VideoSection_Wrapper=styled_components_browser_esm.default.div`
  margin-bottom: 16px;
...
`;var icons_Information=Object(styled_components_browser_esm.default)(({className:className})=>Object(jsx_runtime.jsx)("span",{className:className,dangerouslySetInnerHTML:{__html:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">\n<path fill="#fff" fill-rule="evenodd" d="M7.41 15.705l4.59-4.58 4.59 4.58 1.41-1.41-6-6-6 6 1.41 1.41z" clip-rule="evenodd"/>\n<mask id="k8doq8lq5a" width="12" height="8" x="6" y="8" maskUnits="userSpaceOnUse">\n    <path fill="#fff" fill-rule="evenodd" d="M7.41 15.705l4.59-4.58 4.59 4.58 1.41-1.41-6-6-6 6 1.41 1.41z" clip-rule="evenodd"/>\n</mask>\n</svg>\n'}}))`
  ...
  align-items: center;
  width: 1em;
`,Image=__webpack_require__(46),Image_default=__webpack_require__.n(Image);const Wrapper=styled_components_browser_esm.default.figure`
  display: flex;
  flex-direction: column;
  margin: 0;
`,ImageWrapper=styled_components_browser_esm.default.div`
