...
`,OtherArticles=styled_components_browser_esm.default.div`
  ...
  flex-direction: column;
  ${ArticleHeadline.a} {
    font-size: ${props=>"insider"===props.componentStyle?"18px":"16px"};
    line-height: 22.4px;
    @media ${Styles.c.laptop} {
      font-size: 20px;
      line-height: 28px;
...
//# sourceMappingURL=main.04255cb2e18bb66e08d8.bundle.js.map