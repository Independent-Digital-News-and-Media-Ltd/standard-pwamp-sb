...
`;var article_ArticleCapsule=Object(styled_components_browser_esm.default)(({children:children,className:className,sections:sections,override:override,sponsorName:sponsorName,isLiveBlog:isLiveBlog,isSponsored:isSponsored})=>{let title=sections&&sections[0].name,path=sections&&sections[0].path;return sponsorName&&!sections.filter(s=>"Must Read"===s.name).length&&(title="Promoted content"),isLiveBlog&&(title="LIVE NOW",className+=" live-blog"),override&&!isLiveBlog&&(title=override.name,path=override.path),isSponsored&&(title="SPONSORED"),Object(jsx_runtime.jsxs)("a",{className:className?[className,"capsule"].join(" "):"capsule",href:path,children:[children,title]})})`
  text-decoration: none;
  margin: 12px 0;
  line-height: 21px;
  display: inline-block;
...
`,ArticleX3=props=>{const{hasTitle:hasTitle,data:{labelLink:labelLink,labelText:labelText}}=props;return Object(jsx_runtime.jsxs)(ArticleX3_Wrapper,{hasTitle:hasTitle,children:[labelText&&Object(jsx_runtime.jsx)(components_ComponentTitle,{name:labelText,url:labelLink}),Object(jsx_runtime.jsx)(components_ArticleRow,{...props,srcset:[299,220,280],showLead:!1})]})};ArticleX3.propTypes={data:prop_types_default.a.any.isRequired,labelText:prop_types_default.a.string,labelLink:prop_types_default.a.string,hasTitle:prop_types_default.a.bool},ArticleX3.__docgenInfo={description:"",methods:[],displayName:"ArticleX3",props:{data:{type:{name:"any"},required:!0,description:""},labelText:{type:{name:"string"},required:!1,description:""},labelLink:{type:{name:"string"},required:!1,description:""},hasTitle:{type:{name:"bool"},required:!1,description:""}}};var Section_ArticleX3=ArticleX3;"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["app/component/library/Section/ArticleX3.js"]={name:"ArticleX3",docgenInfo:ArticleX3.__docgenInfo,path:"app/component/library/Section/ArticleX3.js"});const ArticleX4_Wrapper=styled_components_browser_esm.default.div`
  padding-top: ${props=>props.hasTitle?"0":"16px"};
  border-top: ${props=>props.hasTitle?"0":"1px solid "+props.theme.color.navGrey};
  .section-body {
    flex-direction: column;
...
`,ArticleX4=props=>{const{data:{labelLink:labelLink,labelText:labelText},componentStyle:componentStyle,hasTitle:hasTitle}=props;return Object(jsx_runtime.jsxs)(ArticleX4_Wrapper,{hasTitle:hasTitle,children:[labelText&&Object(jsx_runtime.jsx)(components_ComponentTitle,{name:labelText,url:labelLink,titleStyle:componentStyle}),Object(jsx_runtime.jsx)(components_ArticleRow,{...props,srcset:[399,320,380],showLead:!1})]})};ArticleX4.propTypes={data:prop_types_default.a.any.isRequired,componentStyle:prop_types_default.a.any,hasTitle:prop_types_default.a.bool},ArticleX4.__docgenInfo={description:"",methods:[],displayName:"ArticleX4",props:{data:{type:{name:"any"},required:!0,description:""},componentStyle:{type:{name:"any"},required:!1,description:""},hasTitle:{type:{name:"bool"},required:!1,description:""}}};var Section_ArticleX4=ArticleX4;"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["app/component/library/Section/ArticleX4.js"]={name:"ArticleX4",docgenInfo:ArticleX4.__docgenInfo,path:"app/component/library/Section/ArticleX4.js"});const AdDMPU_AdWrapper=styled_components_browser_esm.default.div`
  min-width: 300px;
  position: relative;
  text-align: center;
  background-color: #f4f4f4;
...
//# sourceMappingURL=main.1e55c0eeb61b056db90f.bundle.js.map